...
```
<p><b>Species notes:</b> SAS is Santa Ana Sucker;  Cladophora is green algae; Typha is cattail</p>
<b>Flow metric notes:</b> wet-season baseflow is the magnitude of wet season baseflow (10th percentile of daily flows, during the wet season, including peak flow events); dry-season baseflow is the dry season baseflow magnitude (the 50th percentile of daily flow, during the dry season); wet season peak flow is the 99th percentile of daily flow for the water year.
...
```
<p><b>Species notes:</b> Typha is cattail </p>
<b>Flow metric notes:</b> wet-season baseflow is the magnitude of wet season baseflow (10th percentile of daily flows, during the wet season, including peak flow events); dry-season baseflow is the dry season baseflow magnitude (the 50th percentile of daily flow, during the dry season)
```{r}
...
graphPlan <- reactive({
  ...
  plot(x, y, type='n', xlab="Station (ft)", ylab="Depth (ft)", 
       ...
       cex.lab = 1.5, cex.sub = 3,font.lab = 3, font.main = 3)
