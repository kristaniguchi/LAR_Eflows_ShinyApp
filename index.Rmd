...
```{r}
renderImage({ 
      list(src = "www/LAR_watershedMap_node_reaches.png", height = 625, width =700)
     }, deleteFile =FALSE)  
```
...
```{r}
renderImage({ 
      list(src = "www/LAR_watershedMap_node_reaches.png", height = 625, 
           width =700)
     }, deleteFile =FALSE)  
```
...
```{r}
checkboxInput("showmap","Show Map",FALSE)
```
