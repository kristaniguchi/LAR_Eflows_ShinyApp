...
LA_map_reach <- leaflet(options = 
  ...
  addPolylines(data = reporting_reaches@lines[[1]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[2]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[3]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[4]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[5]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[6]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[7]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[8]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[9]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[10]],weight=4,color = "gray") %>%   
  addPolylines(data = reporting_reaches@lines[[11]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[12]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[13]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[14]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[15]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[16]],weight=4,color = "gray") %>%     
  addPolylines(data = reporting_reaches@lines[[17]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[18]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[19]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[20]],weight=4,color = "gray") %>%
  addPolylines(data = reporting_reaches@lines[[21]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[22]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[23]],weight=4,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[24]],weight=4,color = "gray") %>% 
  addPolylines(data=river2@lines[[4]],weight=5,col='purple') %>% 
  addPolylines(data=river2@lines[[7]],weight=5,col='brown') %>% 
  addPolylines(data=river2@lines[[10]],weight=5,col='green') %>% 
  addPolylines(data=river2@lines[[15]],weight=5,col='#5490d6') %>% 
  addPolylines(data=river2@lines[[16]],weight=5,col='#5490d6') %>% 
  addPolylines(data=river2@lines[[17]],weight=5,col='blue') %>% 
  addPolylines(data=river2@lines[[18]],weight=5,col='purple') %>% 
  addPolylines(data=river2@lines[[19]],weight=5,col='#ff7003') %>% 
  addPolylines(data=river2@lines[[20]],weight=5,col='brown') %>% 
  addPolylines(data=river2@lines[[21]],weight=5,col='#b55d19') %>% 
  addPolylines(data=river2@lines[[22]],weight=5,col='#9041ab') %>% 
  addPolylines(data=river2@lines[[23]],weight=5,col='green') %>%
  addPolylines(data=river2@lines[[24]],weight=5,col='red')
```
