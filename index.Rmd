...
WRP_shp <- tribble(~wrp,~Lat, ~Long,
                   'Tillman', 34.18213, -118.4794,
                   'Burbank', 34.18237, -118.3189,
                   'Glendale', 34.13943, -118.2749)
...
LA_map_reach <- leaflet(options = 
  ...
  addPolylines(data = reporting_reaches@lines[[4]],weight=3,color = "gray") %>% 
  ...
  addPolylines(data = reporting_reaches@lines[[7]],weight=3,color = "gray") %>% 
  ...
  addPolylines(data = reporting_reaches@lines[[10]],weight=3,color = "gray") %>%   
  ...
  addPolylines(data = reporting_reaches@lines[[15]],weight=3,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[16]],weight=3,color = "gray") %>%     
  addPolylines(data = reporting_reaches@lines[[17]],weight=3,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[18]],weight=3,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[19]],weight=3,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[20]],weight=3,color = "gray") %>%
  addPolylines(data = reporting_reaches@lines[[21]],weight=3,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[22]],weight=3,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[23]],weight=3,color = "gray") %>% 
  addPolylines(data = reporting_reaches@lines[[24]],weight=3,color = "gray") %>% 
...
*Figure 2. Proposed process to use optimal flow range of specific management targets with sensitivity curves to evaluate WRP and dry weather stormdrain scenarios. The optimal flow range can be derived from the process shown in Figure ES-3*
