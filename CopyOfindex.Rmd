            ...
            renderUI({
              column(4,
                     if(input$synthesis == "Yes"){
                       radioButtons("synthesis_type",label="Species Synthesis:",
...
synthesis_table <- reactive({
  out <- tibble("Node" = input$Node,
                "Season" = input$season,
                "Species" = select_species(),
                "Current Flow Ranges (cfs)" = synthesis_current_flows(),
                "Optimal Flow Ranges (cfs)" = c(Reduce(intersect,
                                     synthesis()[[1]][grep("Willow",
                                                        c("Cladophora - Adult",
                                                          "Typha - Adult",
                                                          "Typha - Growth",
                                                          "Willow - Adult",
...
#renderPrint({synthesis_current_flows()})
```
