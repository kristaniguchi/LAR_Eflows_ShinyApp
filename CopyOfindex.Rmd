...
sens_curve <- reactive({
  ...
  ggplot(plotter_UBF100, aes(x=x)) +
    geom_line(aes(y = p50_UBF100, colour="50th Percentile"),
              size = 1, linetype = 1, color = "blue") +
    geom_line(data=plotter_UBF50,aes(y = p50_UBF50),
              size = 1, linetype = 2, color = "orange")+ 
    geom_line(data=plotter_UBF0,aes(y = p50_UBF0),
              size = 1, linetype = 3, color = "red")+ 
    labs(x = "Average Annual Season WRP Discharge (cfs)", y = "Season Baseflow Magnitude (cfs)",title="10th - 90th Percentile")+
    ylim(c(0,175)) +
    theme_bw()+
    ...
    geom_ribbon(data =plotter_UBF100,
                aes(ymin=p10_UBF100,ymax=p90_UBF100), fill = 'grey', alpha = .7)+
    geom_ribbon(data =plotter_UBF50,
                aes(ymin=p10_UBF50,ymax=p90_UBF50), fill = '#f0c67d', alpha = .5)+
    geom_ribbon(data =plotter_UBF0,
                aes(ymin=p10_UBF0,ymax=p90_UBF0), fill = '#f0857d', alpha = .5)
...
heatmap_plot <- reactive({
  ...
  heatmap_colors <- setNames(c(hex[c(11,8,7)],"#E7F0F1"), c("Too High","Within Range",
