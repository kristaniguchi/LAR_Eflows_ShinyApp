...
#read in data
data <- read.csv("C:/Users/KristineT/SCCWRP/LA River Eflows Study - General/Reports/Flow recommendations report/synthesis_boxplot_example_GLEN.csv",
...
P1<- ggplot(data, aes(x=Species_Label, ymin = Lower_Limit, lower = Lower_Limit, middle = NA, upper = Upper_Limit, ymax = Upper_Limit, fill=Species_Label)) +
